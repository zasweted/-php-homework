...
function Atimti({ setModalData, modalData, setEditData }) {
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Atimti</h5>
                            ...
                            <div className="modal-footer">
                                <button onClick={save} type="button" className="btn btn-primary">Atimti</button>
